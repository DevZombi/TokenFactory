...
class MyTokenNormalContract extends PolymerElement {
	...
	async _web3Changed(web3) {
		...
		this.tokencontract = await new web3.eth.Contract(this.token_normal_abi, this.address);
	}
...
window.customElements.define('my-token-normal-contract', MyTokenNormalContract);