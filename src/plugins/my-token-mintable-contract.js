...
class MyTokenMintableContract extends PolymerElement {
	...
	async _web3Changed(web3) {
		...
		this.tokencontract = await new web3.eth.Contract(this.token_mintable_abi, this.address);
	}

	async _contractChanged() {
...
window.customElements.define('my-token-mintable-contract', MyTokenMintableContract);